const Footer = () => {
  ...
  <div className="mx-auto w-full max-w-screen-xl">
    <div className="grid grid-cols-2 gap-6 ps-11 py-6 lg:py-8 md:grid-cols-4">
      <div>
    ...
    <div className="px-4 py-6 bg-gray-200  md:flex md:items-center md:justify-between">
      <span className="text-sm text-gray-500 dark:text-black sm:text-center">
        © 2023 <a href="https://flowbite.com/">ElysianBook™</a>. All Rights
        Reserved.
      </span>
      <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
        <a
          href="#"
          className="text-gray-900 hover:text-gray-900 dark:hover:text-blue-700"
        >
          <svg
            className="w-4 h-4"
            aria-hidden="true"
        ...
        <a
          href="#"
          className="text-gray-900 hover:text-gray-900 dark:hover:text-blue-900"
        >
          <svg
            className="w-4 h-4"
            aria-hidden="true"
