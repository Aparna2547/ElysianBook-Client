...
interface ModalProps {
    setNameModal:(value:boolean) =>void
}
const ChangeNameModal = ({setNameModal}:ModalProps) => {
  ...
  <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
   <button onClick={()=>setNameModal(false)}> <svg
    ...
    <form className="space-y-4" onSubmit={changeName}>
